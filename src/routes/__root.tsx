...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "PropAdmin.in" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "PropAdmin.in",
          alternateName: "PropAdmin.in – Your Property Manager",
          description:
            "Integrated property management, housing society management and facility management company in India.",
          email: "info@propadmin.in",
          telephone: "+91 73875 45354",
