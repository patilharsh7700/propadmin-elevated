...
const entries: { path: string; changefreq: string; priority: string }[] = [
  ...
  { path: "/property-management", changefreq: "monthly", priority: "0.9" },
  { path: "/society-management", changefreq: "monthly", priority: "0.9" },
  { path: "/facility-management", changefreq: "monthly", priority: "0.9" },
